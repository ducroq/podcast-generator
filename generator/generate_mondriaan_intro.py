...
VOICES = {
    "emma_en": {
        "ref": "/home/hcl/voice_refs/emma_en.mp3",
    ...
    "lucas_en": {
        "ref": "/home/hcl/voice_refs/lucas_en.mp3",
    ...
    "piet_en": {
        "ref": "/home/hcl/voice_refs/piet_english_sample.mp3",
    ...
    "emma_de": {
        "ref": "/home/hcl/voice_refs/emma_de.mp3",
    ...
    "lucas_de": {
        "ref": "/home/hcl/voice_refs/lucas_de.mp3",
    ...
    "piet_de": {
        "ref": "/home/hcl/voice_refs/piet_de.mp3",
...
import os
os.makedirs("/home/hcl/podcast-generator/mondriaan_output", exist_ok=True)
...
for label, script in [("en", SCRIPT_EN), ("de", SCRIPT_DE)]:
    ...
    for i, (speaker, text) in enumerate(script):
        ...
        sf.write(f"/home/hcl/podcast-generator/mondriaan_output/{label}_{i+1:02d}_{speaker}.wav", wavs[0], sr)

    full = np.concatenate(all_audio)
    out_path = f"/home/hcl/podcast-generator/mondriaan_output/mondriaan_intro_{label}_qwen.wav"
